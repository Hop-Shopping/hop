...
class __TwigTemplate_c92a12f2d1a05e4d97c58b7fb54319d45837061360bff1aa58d9c446fa91518f extends Twig_Template
{
...
";
    ...
    <form method=\"post\" id=\"tblchartform\" action=\"tbl_chart.php\" class=\"ajax\">
        ...
        foreach ($context['_seq'] as $context["idx"] => $context["key"]) {
            // line 59
            echo "                        ";
            if (((isset($context["xaxis"]) ? $context["xaxis"] : null) === null)) {
                // line 60
                echo "                            ";
            ...
            // line 62
            echo "                        ";
            if (((isset($context["xaxis"]) ? $context["xaxis"] : null) === $context["idx"])) {
                // line 63
                echo "                            <option value=\"";
        ...
        foreach ($context['_seq'] as $context["idx"] => $context["key"]) {
            // line 75
            echo "                        ";
            if (twig_in_filter($this->getAttribute($this->getAttribute((isset($context["fields_meta"]) ? $context["fields_meta"] : null), $context["idx"], array(), "array"), "type", array()), (isset($context["numeric_types"]) ? $context["numeric_types"] : null))) {
                // line 76
                echo "                            ";
                if ((($context["idx"] == (isset($context["xaxis"]) ? $context["xaxis"] : null)) && ((isset($context["numeric_column_count"]) ? $context["numeric_column_count"] : null) > 1))) {
                    // line 77
                    echo "                                <option value=\"";
                    echo twig_escape_filter($this->env, $context["idx"], "html", null, true);
                    echo "\">";
        ...
        echo "                </select>
                <input type=\"hidden\" name=\"dateTimeCols\" value=\"
                    ";
        // line 85
        $context["date_time_types"] = array(0 => "date", 1 => "datetime", 2 => "timestamp");
        // line 86
        echo "                    ";
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["keys"]) ? $context["keys"] : null));
        foreach ($context['_seq'] as $context["idx"] => $context["key"]) {
            // line 87
            echo "                        ";
            if (twig_in_filter($this->getAttribute($this->getAttribute((isset($context["fields_meta"]) ? $context["fields_meta"] : null), $context["idx"], array(), "array"), "type", array()), (isset($context["date_time_types"]) ? $context["date_time_types"] : null))) {
                // line 88
                echo "                            ";
                echo twig_escape_filter($this->env, ($context["idx"] . " "), "html", null, true);
                echo "
        ...
        // line 104
        echo twig_escape_filter($this->env, ((((isset($context["xaxis"]) ? $context["xaxis"] : null) ==  -1)) ? (_gettext("X Values")) : ($this->getAttribute((isset($context["keys"]) ? $context["keys"] : null), (isset($context["xaxis"]) ? $context["xaxis"] : null), array(), "array"))), "html", null, true);
        echo "\" />
                <br />
        ...
        foreach ($context['_seq'] as $context["idx"] => $context["key"]) {
            ...
            if (twig_in_filter($this->getAttribute($this->getAttribute((isset($context["fields_meta"]) ? $context["fields_meta"] : null), $context["idx"], array(), "array"), "type", array()), (isset($context["numeric_types"]) ? $context["numeric_types"] : null))) {
                // line 138
                echo "                            ";
                if ((( !(isset($context["selected"]) ? $context["selected"] : null) && ($context["idx"] != (isset($context["xaxis"]) ? $context["xaxis"] : null))) && ($context["idx"] != (isset($context["series_column"]) ? $context["series_column"] : null)))) {
                    // line 139
                    echo "                                <option value=\"";
                    echo twig_escape_filter($this->env, $context["idx"], "html", null, true);
                    echo "\" selected=\"selected\">";
        ...
        echo "                </select>
            ...
            ";
        // line 148
        echo PhpMyAdmin\Util::getStartAndNumberOfRowsPanel((isset($context["sql_query"]) ? $context["sql_query"] : null));
        echo "
            <div class=\"clearfloat\"></div>
...
";
    ...
    {
        return new Twig_Source("", "table/chart/tbl_chart.twig", "/var/www/html/phpmyadmin/templates/table/chart/tbl_chart.twig");
    }
}
