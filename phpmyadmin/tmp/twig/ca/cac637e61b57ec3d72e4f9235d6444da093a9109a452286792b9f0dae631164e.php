...
class __TwigTemplate_98febe4fa2402325e8e8725c274a9363b21832677194d075f6e6d6b14a7a4758 extends Twig_Template
{
    ...
    <div>
        ...
        <input type=\"number\" name=\"pos\" min=\"0\" required=\"required\"
            ";
        // line 5
        if (((isset($context["unlim_num_rows"]) ? $context["unlim_num_rows"] : null) > 0)) {
            // line 6
            echo "max=\"";
            echo twig_escape_filter($this->env, ((isset($context["unlim_num_rows"]) ? $context["unlim_num_rows"] : null) - 1), "html", null, true);
            echo "\"";
        }
        // line 8
        echo "            value=\"";
...
";
    ...
    {
        return new Twig_Source("", "start_and_number_of_rows_panel.twig", "/var/www/html/phpmyadmin/templates/start_and_number_of_rows_panel.twig");
    }
}
